          ...
          <div className="w-2/3">
            {selectedReport ? (
              <ReportDetails
                  ...
                  try {
                    const response = await fetch(`${API_URL}/api/reports/${id}`, {
                      ...
                      body: JSON.stringify({
                        ...
                        numero_habitacion: updatedReport.roomNumber,
                    ...
                    setReports(prevReports => prevReports.map(r => r.id === id ? updatedReport : r));
                  } catch (error) {
                ...
                onDeleteUpdate={async (reportId, updateIndex) => {
                  try {
                    const report = reports.find(r => r.id === reportId);
                    if (!report || !report.updates[updateIndex]) {
                      throw new Error('Update not found');
                    }
                    const updateId = report.updates[updateIndex].id;
              ...
              try {
                const response = await fetch(`${API_URL}/api/reports`, {
                  ...
                  body: JSON.stringify({
                    ...
                    numero_habitacion: newReport.roomNumber,
